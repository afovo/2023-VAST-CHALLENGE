...
import json
import numpy as np
from ge import classify, DeepWalk
...
def evaluate_embeddings(embeddings):
    X, Y = classify.read_node_label('../data/labels.txt')
    tr_frac = 0.8
...
if __name__ == "__main__":
    ...
    model.train(window_size=5, iter=5000)
    ...
    sio.savemat('deepwalk_res.mat', graph_data)
